...
//Requires the Job Aggregator Service (seeds DB + starts cron)
const { startCronJob } = require("./services/jobAggregator");
...
// Keep upload and AI errors inside the existing flash-message user experience.
...
app.listen(port, (err) => {
	...
	// Start job aggregator (seeds jobs/internships + schedules cron)
	startCronJob();
});
