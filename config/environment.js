...
const development = {
	...
	session_cookie_key: process.env.DEVELOPMENT_SESSION_COOKIE_KEY || process.env.SESSION_SECRET,
	db: process.env.DEVELOPMENT_DB || process.env.MONGODB_URI,
...
const production = {
	...
	session_cookie_key: process.env.SESSION_COOKIE_KEY || process.env.SESSION_SECRET,
	db: process.env.DB || process.env.MONGODB_URI,
	db_name: process.env.DB_NAME,
	deployment: process.env.DEPLOYMENT,
